...
export const AdminPanel: React.FC<AdminPanelProps> = ({ isOpen, onClose }) => {
    ...
    const loadAdminAccounts = () => {
        try {
            const stored = localStorage.getItem('dknight_admin_accounts');
            if (stored) {
                ...
                localStorage.setItem('dknight_admin_accounts', JSON.stringify(defaultAdmins));
            }
        } catch (error) {
    ...
    const saveAdminAccounts = (accounts: string[]) => {
        try {
            localStorage.setItem('dknight_admin_accounts', JSON.stringify(accounts));
